...
public class ResponsePageDto<T> extends PageImpl<T> {
    ...
    //@JsonCreator é usado para informar ao Jackson que esse construtor será usado na desserialização.
    //o 'mode = JsonCreator.Mode.PROPERTIES' é por ter mais de uma propriedade no construtor
